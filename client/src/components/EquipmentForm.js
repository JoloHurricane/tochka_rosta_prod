...
function AboutForm(){
  ...
  const updateHandler= async ()=>{
    try{
      ...
      const data=await request(`/api/equipment-edit/update`,'POST',{...form} , 
      {},'application/json')
...
const createHandler = async()=>{
  try{
    const data=await request(`/api/equipment-edit/create`,'POST',{...form} , 
    {},'application/json')
    message(data.message)
          ...
          <div className="row">
            ...
            <div className="adm-form col s12 m12">
                ...
                <form onSubmit={submitHandler} method="post" enctype="multipart/form-data">
                    ...
                    <h4 className="col s8 offset-s4">Изменение информации об оборудовании</h4>
